  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full mb-6 md:mb-14 lg:mb-16 pt-24 md:pt-32">
        {/* Desktop Image */}
        <img
          src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2030%20(4).png"
          alt="Raastay Desktop"
        ...
        {/* Mobile Image */}
        <img
          src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2020%20(5).png"
          alt="Raastay Mobile"
      ...
      <div className="text-center px-4 pb-20">
        ...
        <p
          ...
          style={{ fontFamily: "Blacker Display, serif" }}
        >
          A pure cotton silk saree with the Urdu word 'رنج' screen-printed all over in calligraphic form. The word can be changed, as this piece expresses what our tongues cannot speak
        </p>
      </div>
      ...
      <div className="bg-white text-black py-2 md:py-12">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 max-w-7xl mx-auto px-6">
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2022%20(6).png"
        ...
        <div className="relative w-full mb-6 md:mb-12 lg:mb-14 pt-8 md:pt-8">
          {/* Desktop Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2022%20(7).png"
            alt="Raastay Desktop"
          ...
          {/* Mobile Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2024%20(9).png"
            alt="Raastay Mobile"
            className="block md:hidden w-full h-[505px] object-cover object-center"
          />
        </div>
