    ...
    <div className="w-full">
      ...
      <div className="text-center px-4 pb-20">
        ...
        <p
          ...
          style={{ fontFamily: "Blacker Display, serif" }}
        >
          Describes phool as a saree. Pure tissue silk, custom-dyeable to match the essence of your favourite flower 🌷
        </p>
      </div>
      ...
      <div className="bg-white text-black py-2 md:py-12">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 max-w-7xl mx-auto px-6">
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/B3B0363E-3ACE-4421-9B8E-867E60D038BC%202.JPG"
          ...
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/1C01E275-5A51-499E-A6E2-94F8FBA5532C.JPG"
        ...
        <div className="relative w-full mb-6 md:mb-12 lg:mb-14 pt-8 md:pt-8">
          {/* Desktop Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/phool.png"
            alt="Raastay Desktop"
          ...
          {/* Mobile Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2024.png"
            alt="Raastay Mobile"
            className="block md:hidden w-full h-[505px] object-cover object-center"
          />
        </div>
