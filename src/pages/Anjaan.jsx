  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full mb-6 md:mb-14 lg:mb-16 pt-24 md:pt-32">
        {/* Desktop Image */}
        <img
          src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(2).png"
          alt="Raastay Desktop"
        ...
        {/* Mobile Image */}
        <img
          src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(1).png"
          alt="Raastay Mobile"
      ...
      <div className="text-center px-4 pb-20">
        ...
        <p
          ...
          style={{ fontFamily: "Blacker Display, serif" }}
        >
          Red pure organza sarree embossed with "پتہ بوٹی" hand embroidery. Paired with Brunswick green Indian masuri blouse. The embroidery is practiced exclusively in a small bazaar "Resham Gali" In Hyderabad, Pakistan..
        </p>
      </div>
      ...
      <div className="bg-white text-black py-2 md:py-12">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 max-w-7xl mx-auto px-6">
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(4).png"
          ...
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(3).png"
        ...
        <div className="relative w-full mb-6 md:mb-12 lg:mb-14 pt-8 md:pt-8">
          {/* Desktop Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(6).png"
            alt="Raastay Desktop"
          ...
          {/* Mobile Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/anjaan%20(5).png"
            alt="Raastay Mobile"
            className="block md:hidden w-full h-[505px] object-cover object-center"
          />
        </div>
