  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full mb-6 md:mb-14 lg:mb-16 pt-24 md:pt-36">
        {/* Desktop Image */}
        <img
          src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2021%20(3).png"
          alt="Raastay Desktop"
      ...
      <div className="text-center px-4 pb-20">
        ...
        <p
          ...
          style={{ fontFamily: "Blacker Display, serif" }}
        >
          Silk organza saree embellished with golden moons and stars. Each moon and star is finely detailed, as though plucked from a night sky and set upon the pallu. The gold embroidery stands out beautifully against the white soft, sheer fabric. The blouse is adorned with the same moons made of dabka work, giving off a traditional vibe.
        </p>
      </div>
      ...
      <div className="bg-white text-black py-2 md:py-12">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 max-w-7xl mx-auto px-6">
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2013%20(6).png"
        ...
        <div className="relative w-full mb-6 md:mb-12 lg:mb-14 pt-8 md:pt-8">
          {/* Desktop Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2022%20(5).png"
            alt="Raastay Desktop"
          ...
          {/* Mobile Image */}
          <img
            src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2024%20(8).png"
            alt="Raastay Mobile"
            className="block md:hidden w-full h-[505px] object-cover object-center"
          />
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 max-w-7xl mx-auto px-6">
          ...
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2026%20(6).png"
              alt="Packaging Image"
              className="w-full h-full object-cover rounded-md"
            />
          </div>
          ...
          <div className="w-full md:w-[620px] md:h-[720px]">
            <img
              src="https://palfreyandgulabo.sfo3.cdn.digitaloceanspaces.com/Rectangle%2026%20(7).png"
